...
const healthProducts: HealthProduct[] = [
  {
    ...
    emoji: "🍎",
    benefits: [
      "Natural blend of apple, beetroot, and carrot with crunchy nuts",
      "Delicious daily nutrition drink for kids and adults alike",
      "Wholesome energy from whole food ingredients and country sugar",
      "Traditional malt preparation without synthetic additives",
    ],
  ...
  },
  {
    ...
    emoji: "🥛",
    benefits: [
      "Traditional turmeric with black pepper for wholesome daily nourishment",
      "Warming and soothing cup for monsoon and winter evenings",
      "Comforting bedside drink supporting relaxed evening routine",
      "Curcumin-rich whole coastal turmeric with cardamom and ginger",
    ],
  ...
  },
  {
    ...
    emoji: "🌾",
    benefits: [
      "Naturally rich in anthocyanin plant nutrients",
      "Wholesome dietary fiber for balanced nutrition",
      "Traditional heritage grain nourishing active lifestyles",
      "Ancient Tamil supergrain prized across coastal kitchens",
    ],
  ...
  },
  {
    ...
    emoji: "☕",
    benefits: [
      "Traditional comforting warmth during chilly weather",
      "Aromatic digestive herbal infusion after hearty meals",
      "100% caffeine-free natural herbal blend",
      "Traditional home brew loved by all generations",
    ],
  ...
  },
  {
    ...
    emoji: "🥗",
    benefits: [
      "Traditional roasted multi-seed and millet formulation",
      "Wholesome wholesome snack replacement to support balanced eating",
      "High fiber and roasted millet plant protein",
      "Slow-release complex carbohydrates keep you feeling full",
    ],
